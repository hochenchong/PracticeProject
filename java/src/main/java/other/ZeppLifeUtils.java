...
/**
 * Zepp Life 步数修改工具
 *     请求的是华米 APP Zepp Life 接口，然后同步到微信运动
 *     代码源自：https://www.52pojie.cn/forum.php?mod=viewthread&tid=1584284
 *     改动的地方：
 *        1. 原本只支持手机号码登录，新增邮件登录支持
 *        2. 移除从淘宝 api 获取服务器时间（api 好像失效了），直接从本地获取时间
 *
 * @date 2024/09/29
 */
public class ZeppLifeUtils {
    ...
    /**
     * 登录华米，并获取到 login_token 和 user_id
     *
     * home.php?mod=space&uid= username 华米手机号/邮箱
     * @param password 华米密码
     * home.php?mod=space&uid= user_id login_token
     */
    public static String[] login(String username, String password) {
        ...
        String url = "https://api-user.huami.com/registrations/" + urlUser + "/tokens";
        ...
        String body = HttpRequest.post("https://account.huami.com/v2/client/login")
                ...
                .form("app_version", isPhone ? "4.6.0" : "6.3.5")
                .form("code", login[0])
                ...
                .form("third_name", isPhone ? "huami_phone" : "email")
                .execute().body();
    ...
    public static String sport(String username, String password, String steps) {
        ...
        String body = HttpRequest.post("https://api-mifit-cn.huami.com/v1/data/band_data.json?&t=" + t)
                .header("apptoken", appToken)
                .header("Content-Type", "application/x-www-form-urlencoded")
                .body(bodys)
                .execute().body();
        return JSONUtil.parseObj(body).getStr("message");
    }
    ...
    public static void main(String[] args) {
        ...
        String step = "88888";
        String result = sport(user, password, step);
        log.info("修改步数结果：{}", result);
    }
}
